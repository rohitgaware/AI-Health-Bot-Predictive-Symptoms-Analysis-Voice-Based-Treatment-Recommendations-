...
class LoginPage(ctk.CTk):
    ...
    def initialize_components(self):
        ...
        title_label = ctk.CTkLabel(self, text="Welcome to HealthBot", font=("Arial", 20, "bold"), text_color="white")
        title_label.grid(row=0, column=0, columnspan=2, padx=10, pady=(50, 50))
        
        # Username Label and Entry
        username_label = ctk.CTkLabel(self, text="Username:", font=("Arial", 15, "bold"), text_color="white")
        ...
        password_label = ctk.CTkLabel(self, text="Password:", font=("Arial", 15, "bold"), text_color="white")
        ...
        if not os.path.exists("credentials.txt"):
            # Signup Link
            signup_link = ctk.CTkLabel(self, text="Don't have an account? Sign Up",  cursor="hand2", text_color="white")
            signup_link.grid(row=4, column=0, columnspan=2, padx=10, pady=(0, 10), sticky="ew")
            signup_link.bind("<Button-1>", self.signup)
        else:
            # Forgot Password Link
            forgot_password_link = ctk.CTkLabel(self, text="Forgot Password?", cursor="hand2", text_color="white")
